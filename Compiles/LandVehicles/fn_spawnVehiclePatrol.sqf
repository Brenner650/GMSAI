...
diag_log format["[GMSAI] _fnc_spawnVehiclePatrol: _vehicle = %1 | _crewCount = %2 | _group = %3 | units _group %4 | _difficulty = %5",_vehicle,_crewCount,_group,units _group,_difficulty];
...
diag_log format["_fnc_spawnVehiclePatrol: driver = %1",driver _vehicle];
