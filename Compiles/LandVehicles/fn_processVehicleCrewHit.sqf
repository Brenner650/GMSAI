...
if (!(isPlayer _instigator)) exitWith {_unit setDamage 0};  // AI seem to drive into things thereby damaging the units transported by the vehicle so fix any damage in this case.
